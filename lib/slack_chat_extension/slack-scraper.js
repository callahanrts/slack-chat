...
$("body").prepend("<style>.slackchat { height: 20px; width: 100%; position: absolute; top: 0; left:0; background-color: #000; color: #ccc; z-index: 999; opacity: 0.5; text-align: center; }</style>");
